...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 12), // int()(struct futhark_context *, struct futhark_f32_2d * *, float, int64_t, float, float, float, float, float, float)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 13), // struct futhark_context *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 14), // struct futhark_f32_2d * *
/*  3 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 13), // float
/*  4 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 23), // int64_t
...
/* 13 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // struct futhark_context
/* 14 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // struct futhark_f32_2d *
/* 15 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // struct futhark_f32_2d
};

static int _cffi_d_futhark_entry_main(struct futhark_context * x0, struct futhark_f32_2d * * x1, float x2, int64_t x3, float x4, float x5, float x6, float x7, float x8, float x9)
{
  return futhark_entry_main(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_futhark_entry_main(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "futhark_entry_main", 10, 10, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9))
    return NULL;
  ...
  _cffi_restore_errno();
  { result = futhark_entry_main(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_futhark_entry_main _cffi_d_futhark_entry_main
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "futhark_entry_main", (void *)_cffi_f_futhark_entry_main, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_futhark_entry_main },
};

static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "futhark_context", 13, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
  { "futhark_f32_2d", 15, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__lv_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__lv_cffi(void) { return NULL; }
#  else
     init_lv_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__lv_cffi(void)
{
  return _cffi_init("_lv_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_lv_cffi(void)
{
  _cffi_init("_lv_cffi", 0x2601, &_cffi_type_context);
}
#endif
